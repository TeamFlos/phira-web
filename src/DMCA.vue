  ...
  <div class="flex flex-row justify-center w-full">
    <article class="card bg-base-100 shadow-xl mx-8 prose max-w-none w-full lg:w-3/4 p-4 overflow-x-auto">
      ...
      <ol>
        ...
        <li>State that the notifier has a good faith belief that use of the material in the manner complained of is not authorised by the copyright owner, its agent, or the law.</li>
        <li>State that the information in the notification is accurate, and under penalty of perjury, that the notifying party is authorised to act on behalf of the owner of the copyright that is allegedly infringed.</li>
