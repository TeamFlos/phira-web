<template>
  <div class="flex flex-row justify-center w-full">
    <article
      class="card bg-base-100 shadow-xl mx-8 prose max-w-none w-full lg:w-3/4 p-4 overflow-x-auto"
    >
      <h1>DMCA Policy</h1>
      <p>
        Phira is a community-driven rhythm game, devoid of commercial intent. We
        do not generate any profit either directly or indirectly. We operate
        solely on user donations. Although we demand users to obtain legal
        license of used assets before uploading levels, it may not be observed
        in some cases.
      </p>
      <p>
        We respect the intellectual property rights of others and expects our
        users to do the same. In accordance with the Digital Millennium
        Copyright Act of 1998, Phira will respond expeditiously to claims of
        copyright infringement committed using the Phira service and/or the
        Phira website (the “Site”) if such claims are reported to our Designated
      ...
      <p>
        ...
        Site by completing the following DMCA Notice of Alleged Infringement and
        delivering it to our Designated Copyright Agent. Upon receipt of Notice
        as described below, Phira will take whatever action, in its sole
      ...
      <ol>
        ...
        <li>
          State that the notifier has a good faith belief that use of the
        ...
        <li>
          ...
          penalty of perjury, that the notifying party is authorised to act on
      ...
      <div class="divider"></div>
      <p>
        Complete this notice and deliver it to Phira’s Designated Copyright
        Agent:
      </p>
      <pre>
Copyright Agent
