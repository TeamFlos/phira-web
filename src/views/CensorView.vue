...
const tab = ref<'text' | 'policy'>('text');
...
<template>
  <div class="flex flex-col items-center px-4 py-8">
    ...
    <div class="tabs">
      <a class="tab tab-lifted text-base-content" :class="{ 'tab-active': tab === 'text' }" @click="tab = 'text'">{{ t('text-check') }}</a>
      <a class="tab tab-lifted text-base-content" :class="{ 'tab-active': tab === 'policy' }" @click="tab = 'policy'">{{ t('policy') }}</a>
    </div>
