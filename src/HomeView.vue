  ...
  <div class="hero min-h-[calc(100vh-4rem)]">
    <div class="hero-content justify-center flex-col lg:flex-row">
      ...
      <div class="flex-col text-center">
        <h1 class="font-title font-black text-left text-8xl font-halva tracking-widest bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text [-webkit-text-fill-color:transparent]">Phira</h1>
        <p class="text-xl">Phigros 二创社区</p>
