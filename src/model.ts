...
export type CompositeStatus = S['CompositeStatus'];
export type CpTrackDoc = S['CpTrackDoc'];
export type CpArtistDoc = S['CpArtistDoc'];
export type CpRightsHolderDoc = S['CpRightsHolderDoc'];
export type ReviewCheckR = S['ReviewCheckR'];
export type PolicySearchR = S['SearchR'];
